...
--
-- Host: 127.0.0.1
-- Tempo de geração: 18-Fev-2023 às 01:04
...
CREATE TABLE `autorização de viagem` (
  ...
  `FoodUnitaryValue` decimal(10,2) NOT NULL,
  `HostingUnitaryValue` decimal(10,2) NOT NULL,
  `FoodTotalValue` decimal(10,2) NOT NULL,
  `HostingTotalValue` decimal(10,2) NOT NULL,
  `ExpanseTotalValue` decimal(10,2) NOT NULL,
...
('20230218000238_migrationPublication', '3.0.0');
